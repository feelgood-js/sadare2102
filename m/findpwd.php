...
-->
		...
		<div class="basic_btn_area">
			...
			<A HREF="./login.php" class="basic_button" style="background:#766dc1;border:none;color:#fff;">로그인</a>
		</div>
	</div>
</div>
...
<style type="text/css">
    ...
    .h_area2>h2{font-weight: bold;background: none;border: none;}
    .basic_btn_area{width:90%;margin:0 auto;}
</style>