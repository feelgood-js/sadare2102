...
if(!$_ShopInfo->getMemid() && $_REQUEST["board"] == "all") {
...
}else if($_ShopInfo->getMemid() && $_REQUEST["board"] == "all") {
...
<?include_once('footer.php');?>
        ...
        <style type="text/css">
            ...
            .h_area2{background: none;border: none;}

            .h_area2>h2{background: none;border: none;font-weight: bold;}

            .pr_navi .basic_select{width: auto;line-height: 34px;}

            .grayBtnMini{background:#766DC1;border:none;}

            .basic_btn_area{width:90%;margin: 20px auto;}
