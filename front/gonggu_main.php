				...
				<tr>
					<td>
						<table cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td>
									<h1 class="subpageTitle">공동구매</h1>
									<!--<IMG SRC="../images/design/gonggu_title01.gif" ALT=""><IMG SRC="../images/design/gonggu_title01_text.gif" ALT="">-->
								</td>
						...
						<table cellpadding="0" cellspacing="0">
							...
							<tr>
								<td style="position:relative;">
									<table cellpadding="0" cellspacing="0" border="0" width="100%" style="border:1px solid #eeeeee; table-layout:fixed;">
										<tr>
