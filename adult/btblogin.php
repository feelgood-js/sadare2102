...
<tr>
	...
	<table cellpadding="0" cellspacing="0">
	<tr>
		<td><font color="#000000" style="font-size:11px;">비밀번호를 잊으셨거나 로그인이 되지 않을경우 관리자(<?=$info_email?>)에게 연락하여 주시기 바랍니다.<br />
		<font style="font-size:8pt;"><? echo $shopname ?>(<? echo $info_tel ?>), <a href="mailto:<? echo $info_email ?>" style="background-color:#fe9602;color:#ffffff"><? echo $info_email ?></a></font></td>
	</tr>
	</table>
	</td>
</tr>
